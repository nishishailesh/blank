...
elseif($action=='print_all_rows')
{
	//to show vertical data
	//only_show_all_rows($link,$d,$t,$offset,$GLOBALS['limit'],$GLOBALS['default']);
	
	//to show horizontal data
...
elseif($action=='print_horizontal')
{
	print_horizontal_all($link,$d,$t,mk_select_sql_from_default($link,$d,$t,$default));
}
tail();
